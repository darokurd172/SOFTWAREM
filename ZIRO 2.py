...
tkaya gar edit dakayt ba nawman la gal bet
...
def action():
    global cpb
    global oks
    bch = raw_input('\n\x1b[1;91mhalzhera  \x1b[1;97m>>>\x1b[1;90m  ')
    if bch == '':
        ...
        try:
            c = raw_input('\x1b[1;96m zhmareyak dane   : ')
            k = '+964'
            idlist = '.txt'
